...
def main():
    ...
    get_vcenter_template_status()

def get_vcenter_template_status():
    resp = get_api_data('{}/vcenter/vm-template'.format(api_url))
    j = resp.json()
    print('Template: {}'.format(j['value']))   # This is 2nd Change to put data into YAML format..anil
    # print('Datastore: {}'.format(j['value']))
