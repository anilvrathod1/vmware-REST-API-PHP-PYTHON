...
api_url = 'https://cos-ahs-evc-004.ahs.cos.lan/rest'
...
def main():
    ...
    get_vcenter_folder_status()

def get_vcenter_folder_status():
    resp = get_api_data('{}/vcenter/folder'.format(api_url))
    #j = resp.json()
    j = resp.content
    #print(yaml.dump('Folder: {}'.format(j['value'])))   # This is 2nd Change to put data into YAML format..anil
    print(format(j))
